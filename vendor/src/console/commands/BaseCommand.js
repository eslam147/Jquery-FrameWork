...
class BaseCommand {
    ...
    parseName(name) {
        ...
        return {
            ...
            namespace: namespace,
            fullPath: name,
            directory: namespace ? path.join('app/Http/requests', namespace) : 'app/Http/requests',
            filePath: namespace 
                ? path.join('app/Http/requests', namespace, className + '.js')
                : path.join('app/Http/requests', className + '.js')
        };
    }
}
