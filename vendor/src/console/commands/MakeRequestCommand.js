...
class MakeRequestCommand extends BaseCommand {
    ...
    addToBootJs(parsed) {
        ...
        try {
            ...
            const requestsCommentIndex = bootJsContent.indexOf('// Requests (vendor/src/requests for FormRequest, app/Http/requests for UserRequest)');
            ...
            const controllersCommentIndex = bootJsContent.indexOf('// Controllers (vendor/src/controllers for Controller, app/Http/controllers for others)');
            ...
            const requestPattern = /(\s+)(['"])(Http\/requests\/[^'"]+\.js)\2,?\s*\n/g;
            ...
            if (lastRequestMatch) {
                ...
                const userRequestIndex = bootJsContent.indexOf("'Http/requests/UserRequest.js'");
                if (userRequestIndex !== -1 && userRequestIndex < controllersCommentIndex) {
                    ...
                    const formRequestIndex = bootJsContent.indexOf("'../vendor/src/requests/FormRequest.js'");
